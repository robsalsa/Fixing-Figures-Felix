...
interface LubricantPageProps {
  params: Promise<{ lang: string }>;
}

export default function LubricantPage({ params }: LubricantPageProps) {
    ...
    <div className="loose-guide-page">
      ...
      <nav className="guild-trace-strip" aria-label="Tutorial path">
        <div className="container guild-trace-inner">
          ...
          <span aria-hidden="true">/</span>
          <span className="current">Lubricant</span>
        </div>
      </nav>
        ...
        <section className="guide-hero" id="top">
          <div className="container hero-grid">
            <div className="hero-copy-block">
              ...
              <h1>Using Lubricant to Loosen Stiff Parts</h1>
              <p className="hero-lead">
                This guide is currently under construction. Check back soon for the full tutorial on using bike lubricant to loosen up stiff joints on your figures.
              </p>
