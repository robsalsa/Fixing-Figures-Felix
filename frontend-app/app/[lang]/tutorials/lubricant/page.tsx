...
import translations from '@/lib/translations/tutorial-languages/lube.json';
    ...
    <div className="loose-guide-page">
      ...
      <nav className="guild-trace-strip" aria-label="Tutorial path">
        <div className="container guild-trace-inner">
          ...
          <span aria-hidden="true">/</span>
          <Link href={`/${lang}/tutorials/stiff-parts`}>{t.breadcrumb.current}</Link>
          <span aria-hidden="true">/</span>
          <Link href={`/${lang}/tutorials/stiff-parts#method-library`}>{t.breadcrumb.other}</Link>
          <span aria-hidden="true">/</span>
          ...
          <div className="container">
            ...
            <div className="video-grid">
               <article className="video-card">
                ...
                >
                  <iframe
                    src="https://www.youtube.com/embed/rpPqPoViB2M?si=Zz0122UalYVKkJi4"
