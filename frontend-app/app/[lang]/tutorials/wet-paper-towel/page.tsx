...
interface WetPaperTowelPageProps {
  params: Promise<{ lang: string }>;
}

export default function WetPaperTowelPage({ params }: WetPaperTowelPageProps) {
    ...
    <div className="loose-guide-page">
      ...
      <nav className="guild-trace-strip" aria-label="Tutorial path">
        <div className="container guild-trace-inner">
          ...
          <span aria-hidden="true">/</span>
          <span className="current">Wet Paper Towel</span>
        </div>
      </nav>
        ...
        <section className="guide-hero" id="top">
          <div className="container hero-grid">
            <div className="hero-copy-block">
              ...
              <h1>Using a Wet Paper Towel to Fix Loose Parts</h1>
              <p className="hero-lead">
                This guide is currently under construction. Check back soon for the full tutorial on using a wet paper towel to add friction and tighten loose joints on your figures.
              </p>
